...
number = '+17733075720'
orig = 'NYC' #CHI, NYC, FLL, 

def flight_search():
	#gets flight results 
	results_json = f_api.inspiration_search(
	    origin = orig, #use self.guest if class
	    departure_date = '2016-06-01--2016-06-30', #format should be "2015-11-25--2015-11-30"
	    max_price = '1000',
	...
	USER_DICT[number] = flights #TODO dont hardcode number
	...
	for trip in flights:
		if x < 3:
			...
			t_api.messages.create(to=number, from_="+15627418823", body=message)
